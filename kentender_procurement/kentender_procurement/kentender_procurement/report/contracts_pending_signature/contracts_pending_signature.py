...
from kentender_procurement.services.contract_queue_queries import (
	...
	get_contracts_pending_signature,
)
...
def execute(filters=None):
	...
	rows = get_contracts_pending_signature(procuring_entity=entity or None)
	keys = ["name", "business_id", "contract_title", "tender", "approval_status", "modified"]
