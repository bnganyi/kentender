...
def execute(filters=None):
	...
	rows = get_tender_clarifications_for_queue(procuring_entity=entity or None)
	data = [tender_clarification_queue_row_values(r) for r in rows]
	return tender_clarification_queue_columns(), data
